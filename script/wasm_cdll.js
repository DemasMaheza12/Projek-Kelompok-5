...
var _get_current_image_path = Module['_get_current_image_path'] = makeInvalidEarlyAccess('_get_current_image_path');
var _get_current_rating = Module['_get_current_rating'] = makeInvalidEarlyAccess('_get_current_rating');
var _set_current_by_index = Module['_set_current_by_index'] = makeInvalidEarlyAccess('_set_current_by_index');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['get_current_image_path'] != 'undefined', 'missing Wasm export: get_current_image_path');
  assert(typeof wasmExports['get_current_rating'] != 'undefined', 'missing Wasm export: get_current_rating');
  assert(typeof wasmExports['set_current_by_index'] != 'undefined', 'missing Wasm export: set_current_by_index');
  ...
  _get_current_image_path = Module['_get_current_image_path'] = createExportWrapper('get_current_image_path', 0);
  _get_current_rating = Module['_get_current_rating'] = createExportWrapper('get_current_rating', 0);
  _set_current_by_index = Module['_set_current_by_index'] = createExportWrapper('set_current_by_index', 1);
